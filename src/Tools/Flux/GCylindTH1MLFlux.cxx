...
FLUXDRIVERREG4(genie,flux,GCylindTH1MLFlux,genie::flux::GCylindTH1MLFlux)
...
//____________________________________________________________________________
GCylindTH1MLFlux::GCylindTH1MLFlux()
{
  this->Initialize();
}
...
//___________________________________________________________________________
bool GCylindTH1MLFlux::GenerateNext(void)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::Clear(Option_t * opt)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::GenerateWeighted(bool gen_weighted)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::Initialize(void)
{
  LOG("Flux", pNOTICE) << "Initializing GCylindTH1MLFlux driver";
...
//___________________________________________________________________________
void GCylindTH1MLFlux::ResetSelection(void)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::CleanUp(void)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::SetNuDirection(const TVector3 & direction)
{
  if(fDirVec) delete fDirVec;
  fDirVec = new TVector3(direction);
}
//___________________________________________________________________________
void GCylindTH1MLFlux::SetBeamSpot(const TVector3 & spot)
{
  if(fBeamSpot) delete fBeamSpot;
  fBeamSpot = new TVector3(spot);
}
//___________________________________________________________________________
void GCylindTH1MLFlux::SetTransverseRadius(double Rt)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::AddEnergySpectrum(int nu_pdgc, TH1D * spectrum)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::SetRtDependence(string rdep)
{
...
//___________________________________________________________________________
void GCylindTH1MLFlux::AddAllFluxes(void)
{
...
//___________________________________________________________________________
int GCylindTH1MLFlux::SelectNeutrino(double Ev)
{
...
//___________________________________________________________________________
double GCylindTH1MLFlux::GeneratePhi(void) const
{
  RandomGen * rnd = RandomGen::Instance();
...
//___________________________________________________________________________
double GCylindTH1MLFlux::GenerateRt(void) const
{
