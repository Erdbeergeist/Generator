...
\class   genie::flux::GCylindTH1MLFlux
...
\brief   A generic GENIE flux driver.
         ...
         an energy spectrum for each). Beamspot randomly chosen on shpere of
	 radius 500 from 0,0,0
...
#ifndef _G_TH1ML_CYLICDRICAL_FLUX_H_
#define _G_TH1ML_CYLICDRICAL_FLUX_H_
...
class GCylindTH1MLFlux: public GFluxI {
